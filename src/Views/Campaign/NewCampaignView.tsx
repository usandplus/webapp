...
interface CampaignRequest {
  ...
  email: string;
  rfc: string;
  type: UNPBaseEntityType; // e.g., 'campana'
  createdBy: string;
  ownerId: string;
  ownerDisplayName: string;
}

const NewCampaignView: React.FC = () => {
  ...
  const validateForm = (data: CampaignRequest): boolean => {
    const newErrors = {
    ...
    <Container className="py-4">
            ...
            <Card.Body>
              ...
              <Form>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="email"
                    placeholder="correo@tucampana.com"
                    name="email"
      ...
      <Modal show={showModal} onHide={closeModal} centered>
        <Modal.Header closeButton>
          <Modal.Title>Registro de Campaign</Modal.Title>
        </Modal.Header>
